...
(function (Type) {
    ...
    Type.isBuildJsonValue = evil_type_1.EvilType.lazy(function () { return evil_type_1.EvilType.Validator.isSpecificObject(Type.buildJsonValueValidatorObject, {
        additionalProperties: false
    }); });
    ...
    Type.isBuildValueType = evil_type_1.EvilType.lazy(function () { return evil_type_1.EvilType.Validator.isOr(evil_type_1.EvilType.Validator.isString, Type.isBuildPathValue, Type.isBuildJsonValue, Type.isBuildCallValue, Type.isBuildResourceValue); });
    ...
    Type.isSingleBuildMode = evil_type_1.EvilType.lazy(function () { return evil_type_1.EvilType.Validator.isOr(Type.isSinglePrimeBuildMode, Type.isBuildProcessTarget, Type.isBuildReferenceTarget, Type.isBuildMetaTarget); });
    ...
    Type.buildJsonValueValidatorObject = ({ json: evil_type_1.EvilType.Validator.isString,
        value: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isOr(evil_type_1.EvilType.Validator.isString, evil_type_1.EvilType.Validator.isArray(evil_type_1.EvilType.Validator.isString))), });
    ...
    Type.buildModeBaseValidatorObject = ({ base: evil_type_1.EvilType.Validator.isString,
        parameters: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isOr(evil_type_1.EvilType.Validator.isDictionaryObject(Type.isBuildValueType), Type.isBuildJsonValue)), });
    Type.buildPrimeTargetValidatorObject = ({ template: Type.isBuildValueType,
        output: Type.isBuildPathValue, parameters: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isOr(evil_type_1.EvilType.Validator.isDictionaryObject(Type.isBuildValueType), Type.isBuildJsonValue)), });
